...
public class Withdraw extends javax.swing.JFrame {
 CheckPin pin=new CheckPin();
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int Ebal=Integer.parseInt(jTextField1.getText());
        double bal= pin.getBalance();
        
        if(Ebal>=pin.getBalance())
        { 
           jLabel1.setText("Not Sufficient Balance");
        }
        else{
            bal= bal-Ebal;
        jLabel1.setText("Your Current Balance is "+bal);
        }   
